...
internal sealed class VerifyTestGenerator : IIncrementalGenerator
{
    ...
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        context.RegisterSourceOutput(sources.Collect(), static (context, sources) =>
        {
            if (sources.Length > 0)
                context.AddSource("VerifySourceGeneratorsInitialization.g.cs", InitializationSource);
        });
...
""");
    ...
    // lang=C#
    private const string InitializationSource = """
// <auto-generated/>

file static class VerifySourceGeneratorsInitialization
{
...
file static class VerifyTestHelper
{
    ...
    internal static global::System.Threading.Tasks.Task RunTest(string source, global::Microsoft.CodeAnalysis.CSharp.LanguageVersion languageVersion, global::System.Func<global::Microsoft.CodeAnalysis.GeneratedSourceResult, bool> ignoreRule, string snapshotDirectory)
    {
        ...
        global::Xunit.Assert.Empty(results.Diagnostics);
        var targetSources =
            results.Results.SelectMany(r => r.GeneratedSources)
                           .Where(s => !ignoreRule(s))
                           .OrderBy(s => s.HintName, global::System.StringComparer.Ordinal)
                           .Select(s => s.SourceText.ToString())
                           .ToArray();
        var targetSource = targetSources.Length == 0
            ? "// No disposal code generated."
            : string.Join(global::System.Environment.NewLine, targetSources);
