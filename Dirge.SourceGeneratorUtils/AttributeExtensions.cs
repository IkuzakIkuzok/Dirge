...
internal static class AttributeExtensions
{
    ...
    {
        internal global::Dirge.Utils.AttributeExtensions.ArgumentSyntaxList? ArgumentSyntaxList
        {
            get
            {
        ...
        internal bool TryGetNamedArgumentEnumValue<TEnum>(string argumentName, out TEnum value) where TEnum : struct, Enum
        {
            foreach (var namedArg in attribute.NamedArguments)
            {
                ...
                if (!global::Dirge.Utils.AttributeExtensions.EnumCache<TEnum>.ValidValues.Contains(intValue)) break; // Check if the integer value corresponds to a defined enum member.
